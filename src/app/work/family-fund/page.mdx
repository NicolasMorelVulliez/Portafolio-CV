...
export const caseStudy = {
  client: 'Formula 1',
  href: 'https://nicolasmorelvulliez.github.io/formula-1/',
  title: 'Speedway F1: Racing at the Limit',
  description:
    'Welcome to Speedway F1, your premier destination for all things Formula 1! Dive into the heart of the world fastests sport with race updates, driver profiles, technical insights, and vibrant community engagement.',
  summary: [
    'Welcome to Speedway F1, your premier destination for all things Formula 1! Dive into the heart of the world fastests sport with race updates, driver profiles, technical insights, and vibrant community engagement.',
    'Get ready to experience the thrill of racing at the limit!',
  ],
  logo,
  image: { src: imageHero },
  date: '2022-12',
