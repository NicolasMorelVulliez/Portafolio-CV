...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/nicolas-morel-vulliez/', icon: FacebookIcon },
  { title: 'GitHub', href: 'https://github.com/NicolasMorelVulliez?tab=repositories', icon: GitHubIcon },
]
